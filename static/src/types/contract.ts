// Contract types — mirrors frontend-data-types.ts (project root).
// Single source of truth for the frontend. Do not duplicate conflicting types elsewhere.
// See FRONTEND_DATA_SCHEMA.json for the JSON-Schema equivalent.
...
export interface OverviewResponse {
  meta: Meta;
  north_star: Kpi & {
    closed_batch_net_recovery_value_per_t?: number;
    closed_batch_basis?: string;
  };
  kpis: OverviewKpis;
